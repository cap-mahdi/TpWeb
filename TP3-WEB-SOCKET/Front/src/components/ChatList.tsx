...
export const ChatList = () => {
  ...
  const { setCurrentFriend } = useContext(chatContext);

  function handleCurrectFriend(person: IUser) {
  ...
  return (
    <ul
      role="list"
      className="divide-y divide-gray-100 overflow-y-auto mx-w-lg w-72 sm:w-96 lg:w-80 xl:w-96 pt-5 pb-6 pl-4 pr-2"
    >
      <h2 className="text-lg font-semibold leading-6 text-gray-900">Chats</h2>
      <div
        role="search"
        className="p-4 flex items-center gap-x-4 bg-white border-b border-gray-200"
      >
        <input
          type="text"
          placeholder="Search"
      ...
      {people.map((person, index) => (
        <li
          ...
          onClick={() => handleCurrectFriend(person)}
        >
